...
config.set(
    "content.headers.user_agent",
    "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:99.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99 Safari/537.36",
    "https://*.slack.com/*",
)
...
# Change start page
c.url.start_pages = ["https://dash.redds.be"]

# Search engines
c.url.searchengines = {
    'DEFAULT': 'https://search.redds.be/search?q={}',
...
config.bind("M", "hint links spawn mpviv {hint-url}")
